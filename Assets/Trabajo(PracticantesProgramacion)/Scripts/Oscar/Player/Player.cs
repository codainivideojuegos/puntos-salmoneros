...
namespace Player2
{
    ...
    public class Player : MonoBehaviour
    {
        ...
        public void RecibirDano(int dano)
        {
            ...
            UIManagerOscar.Instance.ActualizarVida(vida);
        ...
        public void Murio_O_Gano(Estado estado)
        {
            ...
            {
                AudioManagerOscar.Instance.changeSFX("Muerte");

                if (vida <= 0)
                {
                    UIManagerOscar.Instance.StartCoroutine(UIManagerOscar.Instance.HaciendoFade("Player"));
                    Destroy(gameObject);
                    return;
                }
                else if (vida > 0)
        ...
        {
            AudioManagerOscar.Instance.StopMusic();
            ...
            AudioManagerOscar.Instance.changeMusic(0);
